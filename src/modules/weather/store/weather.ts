...
export const useWeatherStore = defineStore('weather', () => {
    ...
    const isAutoDetectedCity = ref(false)
    ...
    function setSelectedCity(city: City | null): void {
        selectedCity.value = city
    }

    function setCitySearchValue(value: string): void {
        citySearchValue.value = value
    }

    function setWeather(payload: WeatherInfo | null): void {
    ...
    function setIsDetectingCity(value: boolean): void {
        isDetectingCity.value = value
    }

    function setIsAutoDetectedCity(value: boolean): void {
        isAutoDetectedCity.value = value
    }

    function applyAutoDetectedCity(city: City): void {
        selectedCity.value = city
        isAutoDetectedCity.value = true
        citySearchValue.value = ''
    }

    function applyManualSelectedCity(city: City): void {
        selectedCity.value = city
        isAutoDetectedCity.value = false
        citySearchValue.value = `${city.name}, ${city.country}`
    }

    function clearSelectedCity(): void {
    ...
    return {
        ...
        setHourlyForecast,
        setIsDetectingCity,
        setIsAutoDetectedCity,
        applyAutoDetectedCity,
        applyManualSelectedCity,
        clearSelectedCity,
    }
})