<template>
  <section class="panel search-panel">
    <div class="panel__header">
      <h2 class="panel__title">–ù–∞–π—Ç–∏ –≥–æ—Ä–æ–¥</h2>
      <p class="panel__text">–ù–∞—á–Ω–∏ –≤–≤–æ–¥–∏—Ç—å –Ω–∞–∑–≤–∞–Ω–∏–µ –∏ –≤—ã–±–µ—Ä–∏ –Ω—É–∂–Ω—ã–π –≤–∞—Ä–∏–∞–Ω—Ç.</p>
    </div>
    ...
    <div class="search-box">
      <div class="search-box__input-wrapper">
        <input
            ...
            placeholder="–ù–∞–ø—Ä–∏–º–µ—Ä: Riga, Berlin, Tbilisi"
        />
      ...
      <div v-if="isLoading" class="search-box__dropdown">
        <div class="search-box__item">–ü–æ–∏—Å–∫...</div>
      </div>
...
async function handleSelect(city: City): Promise<void> {
  ...
  try {
    ...
    console.error('Œ¯Ë·Í‡ ÔË ÔÓÎÛ˜ÂÌËË ÔÓ„Ó‰˚ ‰Îˇ ‚˚·‡ÌÌÓ„Ó „ÓÓ‰‡', error)
    showErrorToast('ÕÂ Û‰‡ÎÓÒ¸ Á‡„ÛÁËÚ¸ ÔÓ„Ó‰Û ‰Îˇ „ÓÓ‰‡', error)
  } finally {
