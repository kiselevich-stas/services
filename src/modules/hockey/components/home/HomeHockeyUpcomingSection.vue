  ...
  <section class="section-card">
    <div class="section-card__top">
      <div>
        ...
        <h2 class="section-card__title">Будущие матчи</h2>
        <p class="section-card__subtitle">
          Красиво оформленные ссылки на ближайшие игры.
        </p>
      </div>
    ...
    <div v-if="isLoading && !items.length" class="upcoming-grid">
      <div v-for="index in 6" :key="index" class="upcoming-card upcoming-card--skeleton" />
    </div>
